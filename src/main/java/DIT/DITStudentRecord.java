        ...
        if (e.getSource() == addButton) {
                ...
                try {
                    ...
                    for(int i=0; i<model.getRowCount(); i++){
                        ...
                        String sqlQuery = "INSERT INTO ditrecord (Student No., Last Name, First Name, Last Name, Monday, Tuesday, Wedsnesday, Thursday, Friday) VALUES ('"+Studno+"','"+LastName+"'"+FirstName+"''"+MiddleName+"''"+Age+"''"+Birthday+"''"+Gender+"''"+ContactNo+"')";
