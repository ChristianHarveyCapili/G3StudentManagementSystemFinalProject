...
public class DITStudentRecord extends JFrame implements ActionListener {
    ...
    public DITStudentRecord() {
        DITFrame = new JFrame();
        DITFrame.setTitle("Student Information Record");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == addButton) {
            DITFrame.dispose();
            DITStudentForm sa = new DITStudentForm();
        }
        ...
        if (e.getSource() == delButton) {
            ...
            if (selectedRow != -1) {
                ...
                JOptionPane.showMessageDialog(DITFrame, "Student deleted successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(DITFrame, "Error! Please select row to delete.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
        ...
        if (e.getSource() == updateButton) {
            ...
            JOptionPane.showMessageDialog(DITFrame, "Data updated successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
        }

        if (e.getSource() == returnButton) {
            DITFrame.dispose();
            DITSectionRecord bs = new DITSectionRecord();
            bs.DITSectionRecord();
        }
    ...
    private void DeleteData(String studentNo) {
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(DITFrame, "Error deleting student record from database.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void UpdateData(String studentNo, String columnName, String newValue) {
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(DITFrame, "Error updating student record in database.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void DisplayData() {
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(DITFrame, "Error fetching data from database.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    class StudentInfoDialog extends JFrame {
        ...
        public StudentInfoDialog(String studentNo, String lastName, String firstName, String middleName, String age, String birthday, String gender, String contactNo) {
            ...
            setSize(400, 300);
            setLocationRelativeTo(DITFrame);
