...
public class DITStudentGrade extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == returnButton) {
            DITFrame.dispose();
            new DITSectionRecord().DITSectionRecord(); // Corrected instantiation and method call
        }
    ...
    private void updateDataInDatabase() {
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(DITFrame, "Error updating data in database.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void deleteDataFromDatabaseAndTable() {
        try {
            ...
            conn.close();
            JOptionPane.showMessageDialog(DITFrame, "Data deleted successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
        } catch (SQLException ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(DITFrame, "Error deleting data from database.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
