...
public class IEStudentGrade extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == returnButton) {
            IEFrame.dispose();
            new IESectionRecord().IESectionRecord();
        }
    ...
    private void updateDataInDatabase() {
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(IEFrame, "Error updating data in database.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void deleteDataFromDatabaseAndTable() {
        try {
            ...
            conn.close();
            JOptionPane.showMessageDialog(IEFrame, "Data deleted successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
        } catch (SQLException ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(IEFrame, "Error deleting data from database.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
