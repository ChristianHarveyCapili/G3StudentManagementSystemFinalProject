...
public class BSITStudentGrade extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == returnButton) {
            BSITFrame.dispose();
            new BSITSectionRecord().BSITSectionRecord(); // Corrected instantiation and method call
        }
    ...
    private void updateDataInDatabase() {
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(BSITFrame, "Error updating data in database.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void deleteDataFromDatabaseAndTable() {
        try {
            ...
            conn.close();
            JOptionPane.showMessageDialog(BSITFrame, "Data deleted successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
        } catch (SQLException ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(BSITFrame, "Error deleting data from database.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
